            ...
            <h5>제품 수정하기</h5>
                        <form>
                             <div class="form-group">
                               ...
                               <input type="text" class="form-control" placeholder="Enter 제품명" id="product_name" value="${product.product_name}">
                             </div>
                             <div class="form-group">
                               <label for="inventory">재고량:</label>
                               <input type="text" class="form-control" placeholder="Enter 재고량" id="inventory" value="${product.inventory}">
                             </div>
                             <div class="form-group">
                               <label for="price">가격:</label>
                               <input type="text" class="form-control" placeholder="Enter 가격" id="price" value="${product.price}">
                             </div>
